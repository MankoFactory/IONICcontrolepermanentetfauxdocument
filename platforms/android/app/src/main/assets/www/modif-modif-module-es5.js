...
var ModifPageRoutingModule = /** @class */ (function () {
    function ModifPageRoutingModule() {
    }
...
var ModifPageModule = /** @class */ (function () {
    function ModifPageModule() {
    }
...
var ModifPage = /** @class */ (function () {
    ...
    ModifPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ModifPage.prototype.update = function (form) {
        this.isValidFormSubmitted = false;
        if (form.invalid) {
            return;
        }
...
//# sourceMappingURL=modif-modif-module-es5.js.map