...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(_authenfication, _router, formBuilder, alertService, camera, navCtrl, geo) {
    ...
    RegisterPage.prototype.getMyLocation = function () {
        var _this = this;
        this.geo.getCurrentPosition({
            enableHighAccuracy: true
        }).then(function (location) {
            _this.registerForm.value.latitude = location.coords.latitude;
            _this.registerForm.value.longitude = location.coords.longitude;
        });
    ...
    RegisterPage.prototype.openLibrary = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                return [2 /*return*/, this.camera.getPicture(options)];
            });
        });
    };
    ...
    RegisterPage.prototype.addPhoto = function (source, number) {
        var _this = this;
        var result = null;
        if (source == 'camera')
        ...
        if (result != null)
            result.then(function (imageData) {
                ...
                if (number == 1) {
                    _this.imgDevanture = "data:image/jpeg;base64," + imageData;
                    _this.registerForm.get('photo_venture').setValue(imageData);
                    _this.registerForm.value.imgDevanture = _this.imgDevanture;
                }
                else {
                    _this.imageActivite = "data:image/jpeg;base64," + imageData;
                    _this.registerForm.get('photo_activite').setValue(imageData);
                    _this.registerForm.value.imageActivite = _this.imageActivite;
                }
    ...
    RegisterPage.prototype.ajoutUser = function (User) {
        var _this = this;
    ...
    RegisterPage.prototype.dataURItoBlob = function (dataURI) {
    ...
    RegisterPage.prototype.selectChange = function (e) {
        console.log(e);
    };
